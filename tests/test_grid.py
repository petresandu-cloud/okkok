...
class Claims(unittest.TestCase):
    ...
    def test_claim_fails(self):
        v, e, _ = checks.no_unqualified_claims(self.facts("We guarantee delivery. Sample App calls 112 for you."))
...
class Applicability(unittest.TestCase):
    def test_na_is_a_verdict_with_a_reason_and_unknown_without_a_binary(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            self.assertIn("the app declares or uses tracking", r["evidence"])
