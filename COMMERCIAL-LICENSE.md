...
okkok is copyright © 2026 Editerra AB and is published under the GNU
Affero General Public License, version 3 or later (see `LICENSE`).

Under that licence you may use, study, change and redistribute okkok
...
- build okkok, or parts of it, into a product or service that is not
